    ...
    <main className="relative w-full bg-black/20 md:flex md:justify-center md:items-center md:p-10">
      <div className="bg-white/50 flex justify-center items-center  w-full text-center md:rounded-2xl md:shadow-2xl md:px-16 md:flex md:w-3/5 md:max-w-4xl">
        ...
        <div className="w-full p-5">
          ...
          <div>
            <h2 className="text-4xl font-bold text-secondary mb-2 uppercase pt-4">
              WELCOME STYLISTS!
            </h2>
            <h1 className="text-2xl font-semibold text-black/50 text-secondary mb-2 uppercase">
              CREATE AN ACCOUNT TO RECEIVE PREFERRED BENEFITS!
            </h1>
            ...
            <div className="flex flex-col items-center">
              <div className="w-3/4 p-2 flex items-center mb-3 rounded-lg border border-white/30 bg-black/50">
                <FaRegEnvelope className="text-white m-1" />
                <input
                  type="email"
                  name="email"
                  placeholder="email"
              ...
              <div className=" flex ">
                <Link href="/" className="ml-2 py-4 hover:underline">
                  Forgot your password?
                </Link>
                <Link
                  href="/"
                  className=" ml-2 px-2 py-4 text-secondary hover:underline font-semibold"
                >
                  Create new Account
                </Link>
              </div>
