          ...
          >
            <TabPanel value="card" className="p-0">
              <form className="mt-12 flex flex-col gap-4">
                ...
                <Button size="lg">Place Order Now</Button>
                <Typography
                  variant="small"
                  color="gray"
            ...
            <TabPanel value="paypal" className="p-0 overflow-hidden">
              <form className="mt-12 flex flex-col gap-4">
                <div>
                  <p>
                    After clicking in pay with paypal it is showing you a popup
                    modal than you can authorize this and place order
                    respectifully
                  </p>
                </div>
